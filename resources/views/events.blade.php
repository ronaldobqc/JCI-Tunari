...
<head>
	...
	<body>
		...
		<section id="galeria" class="testimonial-area">
			...
			<div class="container">
				...
				<div class="section-title text-center" data-aos="zoom-in" data-aos-duration="1000">
					...
					<h2>Premios:</br>INSPIRA CON UNA IMAGEN</h2>
				</BR>
					<p>
						Las organizaciones locales: JCI TUNARI y JCI EMPRESARIOS LA PAZ, tienen el agrado de invitarle </br>
						a postular tres (3) fotografías a los premios “Inspira con una Imagen” </br></br>
						
						<h3 class="text-center" style="color: black">¿Qué es INSPIRA CON UNA IMAGEN?</h3>

						Es una premiación que busca reconocer a fotógrafos profesionales y/o aficionados
						a nivel nacional, que mediante una o más fotografías inspiren sentimientos
						y emociones en función a una mezcla entre la familia, la naturaleza y la arquitectura nacional.
						Este evento es organizado por la Cámara Junior International Tunari y Empresarios La Paz, que tiene como finalidad promover ese espíritu fotográfico, de
						poder plasmar en una imagen la cotidianeidad de la vida, ligada a la situación
						en la que vivimos a causa del COVID-19 y explorar lo que hay detrás de una
						lente de cámara. 
						</br>
						La fotografía debe inspirar a un sentimiento como por ejemplo: solidaridad, paz,
						amor, valentía, hermandad, perseverancia, paciencia, etc. La fotografía debe tener
						un contexto para poder identificarlo con un sentimiento y tener una breve descripcion
						de la misma
					...
					<div class="section-title text-center">	
						...
						<h3 class="text-center" style="color: black">INSCRIBETE HOY</h3>	
						<a href="https://forms.gle/PiKnNZ4xc7bVygRK9" target="_blank" class="green-btn" style="margin: 10px">Inscribete</a>
					</div>
		...
		<!-- <section class="newsletter-area">
			<div class="container text-center registro">
				<h2>¿Deseas participar del concurso de fotografía?</h2>	
				<div>		
					<a href="https://forms.gle/RrWMNjyJQiPwBxnG7" target="_blank"><button class="btn btn-success">Inscribirme</button></a>	
				</div>
			</div>
		</section> -->
		<!-- End Newsletter -->
